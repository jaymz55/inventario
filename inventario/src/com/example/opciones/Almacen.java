...
public class Almacen {
	...
	public VerticalLayout cuerpo(){
						...
						registrar.addListener(new Button.ClickListener() {
						    public void buttonClick(ClickEvent event) {
						    	...
						    	if(producto.getValue() != null && !cantidad.getValue().equals("") && fechaProduccion.getValue() != null){
			    					...
			    					ConfirmDialog.show(UI.getCurrent(), "Confirmaci�n", "�Est�s seguro de querer registrar la merma? Recuerda que debiste registrar la producci�n de este art�culo antes",
		...
		//Bot�n para salida de producto sin venta
